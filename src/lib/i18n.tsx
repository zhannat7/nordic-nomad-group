...
const t: Translations = {
  ...
  'about.card1.title': {
    en: 'Dedicated interns', da: 'Dedikerede praktikanter', ru: 'Люди на первом месте', ky: 'Адамдар биринчи',
  },
  'about.card1.desc': {
  ...
  'about.card2.title': {
    en: 'Full documentation', da: 'Fuld dokumentation', ru: 'Качественный подбор', ky: 'Сапаттуу тандоо',
  },
  'about.card2.desc': {
  ...
  'about.card3.title': {
    en: 'Ongoing support', da: 'Løbende support', ru: 'Полная поддержка', ky: 'Толук колдоо',
  },
  'about.card3.desc': {
  ...
  'about.card4.title': {
    en: 'Legal & transparent', da: 'Lovligt og gennemsigtigt', ru: 'Законно и прозрачно', ky: 'Мыйзамдуу жана ачык',
  },
  'about.card4.desc': {
