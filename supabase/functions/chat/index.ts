...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompts: Record<string, string> = {
      ky: `Сен Nordic Nomad Group компаниясынын жардамчы ботусуң. Nordic Nomad Group — Данияда катталган рекрутинг агенттиги (CVR: 44829363), Кыргызстандан 18-29 жаштагы мотивациялуу жаштарды Дания фермаларына стажировкага жайгаштырат. Бардык суроолорго кыргыз тилинде жооп бер. Кыска жана так жооп бер. Компания жөнүндө маалымат: практика мөөнөтү 3-18 ай, англис тили талап кылынат, бардык документтерди компания чечет.`,
